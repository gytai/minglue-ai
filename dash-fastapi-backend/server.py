...
from module_device.controller.device_controller import callbackController, deviceController
...
controller_list = [
    ...
    {'router': deviceController, 'tags': ['设备中心-设备管理']},
    {'router': callbackController, 'tags': ['设备中心-回调接入']},
]
