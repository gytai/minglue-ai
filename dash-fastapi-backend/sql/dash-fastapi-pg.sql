...
insert into sys_menu values(5, '设备中心', 0, '1', 'device',           null, '', '', 1, 0, 'M', '0', '0', '', 'antd-control', 'admin', current_timestamp, '', null, '明略硬件设备中心');
-- 二级菜单
...
insert into sys_menu values(118,  '设备管理', 5,   '1', 'manage',     'device.manage',       '', '', 1, 0, 'C', '0', '0', 'device:manage:list',      'antd-mobile',    'admin', current_timestamp, '', null, '明略硬件设备管理');
insert into sys_menu values(119,  '回调日志', 5,   '2', 'callback',   'device.callback_log', '', '', 1, 0, 'C', '0', '0', 'device:callback:list',    'antd-cloud-download', 'admin', current_timestamp, '', null, '设备回调日志');
-- 三级菜单
...
insert into sys_menu values(1061, '设备查询', 118, '1', '#', '', '', '', 1, 0, 'F', '0', '0', 'device:manage:query',        '#', 'admin', current_timestamp, '', null, '');
insert into sys_menu values(1062, '设备新增', 118, '2', '#', '', '', '', 1, 0, 'F', '0', '0', 'device:manage:add',          '#', 'admin', current_timestamp, '', null, '');
insert into sys_menu values(1063, '设备修改', 118, '3', '#', '', '', '', 1, 0, 'F', '0', '0', 'device:manage:edit',         '#', 'admin', current_timestamp, '', null, '');
