-- ============================================================================
-- 明略 AI 硬件数据管理平台 —— MySQL 初始化脚本
--
-- 执行方式（--default-character-set=utf8mb4 不可省略）：
--   mysql --default-character-set=utf8mb4 -u<user> -p<pwd> <db> < sql/dash-fastapi.sql
--
-- 为什么必须指定字符集：本脚本含中文种子数据。若客户端按 latin1 解析，
-- sys_notice.notice_title（varchar(50)）会因字节数超过 50 而报
-- "Data too long for column 'notice_title'"，mysql 客户端默认在该错误处中断，
-- 其后的建表语句（含全部 ml_* 设备相关表）将静默缺失。
-- ============================================================================
...
-- ----------------------------
-- 一级菜单
insert into sys_menu values('1', '系统管理', '0', '1', 'system',           null, '', '', 1, 0, 'M', '0', '0', '', 'antd-setting',   'admin', sysdate(), '', null, '系统管理目录');
insert into sys_menu values('2', '系统监控', '0', '2', 'monitor',          null, '', '', 1, 0, 'M', '0', '0', '', 'antd-fund-projection-screen',  'admin', sysdate(), '', null, '系统监控目录');
insert into sys_menu values('3', '系统工具', '0', '3', 'tool',             null, '', '', 1, 0, 'M', '0', '0', '', 'antd-repair',     'admin', sysdate(), '', null, '系统工具目录');
insert into sys_menu values('4', '若依官网', '0', '4', 'http://ruoyi.vip', null, '', '', 0, 0, 'M', '0', '0', '', 'antd-send',    'admin', sysdate(), '', null, '若依官网地址');
insert into sys_menu values('5', '设备中心', '0', '1', 'device',           null, '', '', 1, 0, 'M', '0', '0', '', 'antd-control', 'admin', sysdate(), '', null, '明略硬件设备中心');
-- 二级菜单
insert into sys_menu values('100',  '用户管理', '1',   '1', 'user',       'system.user',        '', '', 1, 0, 'C', '0', '0', 'system:user:list',        'antd-user',          'admin', sysdate(), '', null, '用户管理菜单');
insert into sys_menu values('101',  '角色管理', '1',   '2', 'role',       'system.role',        '', '', 1, 0, 'C', '0', '0', 'system:role:list',        'antd-team',       'admin', sysdate(), '', null, '角色管理菜单');
insert into sys_menu values('102',  '菜单管理', '1',   '3', 'menu',       'system.menu',        '', '', 1, 0, 'C', '0', '0', 'system:menu:list',        'antd-app-store-add',    'admin', sysdate(), '', null, '菜单管理菜单');
insert into sys_menu values('103',  '部门管理', '1',   '4', 'dept',       'system.dept',        '', '', 1, 0, 'C', '0', '0', 'system:dept:list',        'antd-cluster',          'admin', sysdate(), '', null, '部门管理菜单');
insert into sys_menu values('104',  '岗位管理', '1',   '5', 'post',       'system.post',        '', '', 1, 0, 'C', '0', '0', 'system:post:list',        'antd-idcard',          'admin', sysdate(), '', null, '岗位管理菜单');
insert into sys_menu values('105',  '字典管理', '1',   '6', 'dict',       'system.dict',        '', '', 1, 0, 'C', '0', '0', 'system:dict:list',        'antd-read',          'admin', sysdate(), '', null, '字典管理菜单');
insert into sys_menu values('106',  '参数设置', '1',   '7', 'config',     'system.config',      '', '', 1, 0, 'C', '0', '0', 'system:config:list',      'antd-calculator',          'admin', sysdate(), '', null, '参数设置菜单');
insert into sys_menu values('107',  '通知公告', '1',   '8', 'notice',     'system.notice',      '', '', 1, 0, 'C', '0', '0', 'system:notice:list',      'antd-notification',       'admin', sysdate(), '', null, '通知公告菜单');
insert into sys_menu values('108',  '日志管理', '1',   '9', 'log',        '',                         '', '', 1, 0, 'M', '0', '0', '',                        'antd-bug',           'admin', sysdate(), '', null, '日志管理菜单');
insert into sys_menu values('109',  '在线用户', '2',   '1', 'online',     'monitor.online',     '', '', 1, 0, 'C', '0', '0', 'monitor:online:list',     'antd-desktop',        'admin', sysdate(), '', null, '在线用户菜单');
insert into sys_menu values('110',  '定时任务', '2',   '2', 'job',        'monitor.job',        '', '', 1, 0, 'C', '0', '0', 'monitor:job:list',        'antd-deployment-unit',           'admin', sysdate(), '', null, '定时任务菜单');
insert into sys_menu values('111',  '数据监控', '2',   '3', 'druid',      'monitor.druid',      '', '', 1, 0, 'C', '0', '0', 'monitor:druid:list',      'antd-database',         'admin', sysdate(), '', null, '数据监控菜单');
insert into sys_menu values('112',  '服务监控', '2',   '4', 'server',     'monitor.server',     '', '', 1, 0, 'C', '0', '0', 'monitor:server:list',     'antd-cloud-server',        'admin', sysdate(), '', null, '服务监控菜单');
insert into sys_menu values('113',  '缓存监控', '2',   '5', 'cache',      'monitor.cache.control',      '', '', 1, 0, 'C', '0', '0', 'monitor:cache:list',      'antd-cloud-sync',         'admin', sysdate(), '', null, '缓存监控菜单');
insert into sys_menu values('114',  '缓存列表', '2',   '6', 'cacheList',  'monitor.cache.list',       '', '', 1, 0, 'C', '0', '0', 'monitor:cache:list',      'antd-table',    'admin', sysdate(), '', null, '缓存列表菜单');
insert into sys_menu values('115',  '表单构建', '3',   '1', 'build',      'tool.build',         '', '', 1, 0, 'C', '0', '0', 'tool:build:list',         'antd-build',         'admin', sysdate(), '', null, '表单构建菜单');
insert into sys_menu values('116',  '代码生成', '3',   '2', 'gen',        'tool.gen',           '', '', 1, 0, 'C', '0', '0', 'tool:gen:list',           'antd-console-sql',          'admin', sysdate(), '', null, '代码生成菜单');
insert into sys_menu values('117',  '系统接口', '3',   '3', 'swagger',    'tool.swagger',       '', '', 1, 0, 'C', '0', '0', 'tool:swagger:list',       'antd-api',       'admin', sysdate(), '', null, '系统接口菜单');
insert into sys_menu values('118',  '设备管理', '5',   '1', 'manage',     'device.manage',      '', '', 1, 0, 'C', '0', '0', 'device:manage:list',      'antd-mobile',    'admin', sysdate(), '', null, '明略硬件设备管理');
insert into sys_menu values('119',  '回调日志', '5',   '2', 'callback',   'device.callback_log','', '', 1, 0, 'C', '0', '0', 'device:callback:list',    'antd-cloud-download', 'admin', sysdate(), '', null, '设备回调日志');
-- 三级菜单
insert into sys_menu values('500',  '操作日志', '108', '1', 'operlog',    'monitor.operlog',    '', '', 1, 0, 'C', '0', '0', 'monitor:operlog:list',    'antd-clear',          'admin', sysdate(), '', null, '操作日志菜单');
insert into sys_menu values('501',  '登录日志', '108', '2', 'logininfor', 'monitor.logininfor', '', '', 1, 0, 'C', '0', '0', 'monitor:logininfor:list', 'antd-control',    'admin', sysdate(), '', null, '登录日志菜单');
-- 用户管理按钮
...
insert into sys_menu values('1061', '设备查询', '118', '1', '#', '', '', '', 1, 0, 'F', '0', '0', 'device:manage:query',        '#', 'admin', sysdate(), '', null, '');
insert into sys_menu values('1062', '设备新增', '118', '2', '#', '', '', '', 1, 0, 'F', '0', '0', 'device:manage:add',          '#', 'admin', sysdate(), '', null, '');
insert into sys_menu values('1063', '设备修改', '118', '3', '#', '', '', '', 1, 0, 'F', '0', '0', 'device:manage:edit',         '#', 'admin', sysdate(), '', null, '');
...
insert into sys_dict_data values(10, 1,  '默认',     'default',     'sys_job_group',       '',   'default',        'Y', '0', 'admin', sysdate(), '', null, '默认分组');
insert into sys_dict_data values(11, 2,  '数据库',   'sqlalchemy',  'sys_job_group',       '',   'success',        'N', '0', 'admin', sysdate(), '', null, '数据库分组');
insert into sys_dict_data values(12, 3,  'redis',    'redis',  			'sys_job_group',       '',   'warning',        'N', '0', 'admin', sysdate(), '', null, 'reids分组');
insert into sys_dict_data values(13, 1,  '默认',     'default',  		'sys_job_executor',    '',   'default',        'N', '0', 'admin', sysdate(), '', null, '线程池');
insert into sys_dict_data values(14, 2,  '进程池',   'processpool', 'sys_job_executor',    '',   'primary',        'N', '0', 'admin', sysdate(), '', null, '进程池');
...
insert into sys_config values(6, '账号自助-是否开启忘记密码功能', 'sys.account.forgetUser',        'true',         'Y', 'admin', sysdate(), '', null, '是否开启忘记密码功能（true开启，false关闭）');
insert into sys_config values(7, '用户登录-黑名单列表',           'sys.login.blackIPList',         '',              'Y', 'admin', sysdate(), '', null, '设置登录IP黑名单限制，多个匹配项以;分隔，支持匹配（*通配、网段）');
...
-- 20、明略硬件设备表
-- ----------------------------
drop table if exists ml_device;
create table ml_device (
  device_id bigint(20) not null auto_increment comment '设备主键',
  device_code varchar(100) not null comment '设备唯一编码/SN',
